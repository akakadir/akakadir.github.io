...
Artık sayfanda JQuery'den yararlanabilirsin. Kullanacağımız 3. parti API Aiden Wallis'in Spotify'ı. öncelikle [şu](https://spotify.aidenwallis.co.uk/) adrese gir. *"Login With Spotify"* butonunu kullanarak giriş yapıop, gerekli izinleri ver. Elinde şuan şöyle bir URL olmalı:
