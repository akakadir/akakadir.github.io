...
Peki engelleme yolları var mı? evet, elbette var: ````statik-arp```` kullanımı. Bu yöntem yönlendiricinin MAC adresini bulup, korumak istediğin cihaza statik bir ARP girişi eklemektir. 2007'den kalma bir programın hala işlevselliğini koruması da ayrı bi söylemesi hoş geliyor bana.
