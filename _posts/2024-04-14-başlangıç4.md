...
Hangi taraftan ilerlemek istediğine bağlı olarak değişiyor. Önceki yazımda bu konuya yeterince değindim. (bknz: [başlangıç, sen kimsin?](https://akakadir.github.io/başlangıç2.html))
...
(bknz: [Visual Studio Code](https://code.visualstudio.com))
...
(bknz: [Atom](https://github.com/atom/atom))
...
(bknz: [Sublime Text](https://www.sublimetext.com))
...
(bknz: [PyCharm](https://www.jetbrains.com/pycharm))
...
(bknz: [Eclipse](https://eclipseide.org))
