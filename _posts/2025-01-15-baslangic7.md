...
Çevrimdışı Mod seçeneğinde ZipRipper, yerel bir kaynak dosyası ````zr-offline.txt```` kullanır. Bu mod için internet bağlantısı gerekmez. (Portable kullanım için ideal)
