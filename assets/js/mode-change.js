...
function monitorGiscus() {
    const iframe = document.querySelector("iframe.giscus-frame");
    if (!iframe) {
        console.warn("Giscus iframe yüklenmedi. İzleme başlatılıyor.");
...
// Olay Dinleyicilerini Optimize Edilmiş Şekilde Ekleyelim
...
// Giscus İle İletişim Kesilirse Tekrar Temayı Uygula
