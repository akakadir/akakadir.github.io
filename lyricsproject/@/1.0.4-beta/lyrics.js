...
//embed
addCSS("embed{ width:315px;height:125px;border:none;border-radius:10px; }");
//log
addCSS("#log{ width:319px;color:#fff;font-family:monospace;font-size:13px;background-color:#000;padding:-1px;border:2px solid #111;border-radius:12px; }");
...
var _e='<embed src="//www.youtube-nocookie.com/embed/' + _id[_m] + '"></embed>';
$('.embed').html(_e);
